...
st.markdown("""
    <div style="margin-top: 250px; width: 100%;">
        <h2 style="text-align: center; color: white; margin-bottom: 30px;">About Us</h2>
        <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 80px;">
            <div style="text-align: center; min-width: 200px;">
                <h4 style="color: #ffffff;">Anuraag Patil</h4>
                <p style="color: #d0d0d0;">anuraagpatil10@gmail.com</p>
            </div>
            <div style="text-align: center; min-width: 200px;">
                <h4 style="color: #ffffff;">Anshul Gupta</h4>
                <p style="color: #d0d0d0;">guptaanushul.1410@gmail.com</p>
            </div>
            <div style="text-align: center; min-width: 200px;">
                <h4 style="color: #ffffff;">Dhruva V</h4>
                <p style="color: #d0d0d0;">dhruva.nagveni@gmail.com</p>
            </div>
            <div style="text-align: center; min-width: 200px;">
                <h4 style="color: #ffffff;">Prayag Goyani</h4>
                <p style="color: #d0d0d0;">prayagbgoyani@gmail.com</p>
            </div>
        </div>
    </div>
""", unsafe_allow_html=True)
...
#         <h4>About Us</h4>
#         <ul>
#             <li><strong>Anuraag Patil</strong> – anuraagpatil10@gmail.com</li>
#             <li><strong>Anshul Gupta</strong> – guptaanushul.1410@gmail.com</li>
#             <li><strong>Dhruva V</strong> – dhruva.nagveni@gmail.com</li>
#             <li><strong>Prayag Goyani</strong> – prayagbgoyani@gmail.com</li>
#         </ul>
#     </div>
# """, unsafe_allow_html=True)
#
